...
override_whitelisted_methods = {
    "erpnext.auth.login": "erpnext.api.auth.login",
    "erpnext.auth.signup": "erpnext.api.auth.signup",
	"erpnext.auth.logout": "erpnext.api.auth.logout",
	"erpnext.user.getUsers": "erpnext.api.user.getUsers",
	"erpnext.user.getProfile": "erpnext.api.user.getProfile",
	"erpnext.devisFournisseur.get_supplier_quotations": "erpnext.api.devisFournisseur.get_supplier_quotations",
    "erpnext.devisFournisseur.get_quotation_details": "erpnext.api.devisFournisseur.get_quotation_details",
    "erpnext.devisFournisseur.update_item_rate": "erpnext.api.devisFournisseur.update_item_rate"
}